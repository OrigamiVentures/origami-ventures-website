          ...
          >
            ...
            <ul role="list" className="nav-menu-two-2 w-list-unstyled">
              <li className="list-item-14">
                ...
                <a href="/#team" className="nav-link-4 w--current">
                  Team
                </a>
            ...
            <div className="div-block-50">
              ...
              >
                <img
                  ...
                  loading="lazy"
                  alt="menu-icon"
                  src="https://cdn.prod.website-files.com/67a5fb8bc33c7f25ab4e52d9/68e4b4ad148fb73ce88066c5_menu-icon.svg"
                  className="image-28"
                />
              </div>
              <a
          ...
          <div className="div-block-51">
            <div className="div-block-49">
              ...
              <img
                ...
                loading="lazy"
                alt="close-icon"
                src="https://cdn.prod.website-files.com/67a5fb8bc33c7f25ab4e52d9/68e4b4ad148fb73ce88066c6_cross-black.svg"
                className="image-9"
              />
            </div>
